    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div x-data class="relative group" x-ref="loginEmail">
            ...
            <x-text-input id="email" 
							...
							x-on:blur="$refs.loginEmail.classList.remove('is-focused')"
        ...
        <div x-data class="mt-4 relative group" x-ref="loginPassword">
            ...
            <x-text-input id="password" class="block mt-1 w-full"
						x-on:focus="$refs.loginPassword.classList.add('is-focused');" 
						x-on:blur="$refs.loginPassword.classList.remove('is-focused');"
                            type="password"
                            name="password"
